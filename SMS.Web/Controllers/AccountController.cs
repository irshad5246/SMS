...
namespace SMS.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(SMSUserManager userManager, SMSSignInManager signInManager )
        {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new SMSUser { UserName = model.Username, Email = model.Email,FirstName=model.FirstName,LastName=model.LastName,PhoneNumber=model.PhoneNumber, CountryID= model.CountryID,StateID=model.StateID,CityID=model.CityID };
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new SMSUser { UserName = model.Email, Email = model.Email };
